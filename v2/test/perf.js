...
test('expr-eval', async t => {
  const { Parser } = await import('../../test/lib/parser/expr-eval.min.js');
...
test('subscript', async t => {
  const { parse, compile } = await import('../src/subscript.js');
...
test('jsep', async t => {
  const jsep = await import('../../test/lib/parser/expression-eval.module.js');
...
test('jsep-strip', async t => {
  const { parse } = await import('../../test/lib/parser/jsep-strip.js');
...
test('justin', async t => {
  const { parse, compile } = await import('../src/justin.js');
...
test('jexpr', async t => {
  const { default: parseSS } = await import('../src/subscript.js')
...
test('jexl', async t => {
  const { Jexl } = await import('../../test/lib/parser/jexl.min.js');
...
test('string-math', async t => {
  const { default: sm } = await import('../../test/lib/parser/string-math.js');
...
test('subscript-refs', async t => {
  const { default: dislex, parse: dparse, evaluate } = await import('../../test/lib/parser/subscript-refs.js');
  console.time('dislex')
  for (let i = 0; i < RUNS; i++) {
...
test('subscript-v1', async t => {
  const { default: v1, parse: v1parse, evaluate } = await import('../../test/lib/parser/subscript-lex.js');
...
test('subscript v5', async t => {
  const { parse, evaluate } = await import('../../test/lib/parser/subscript-v5.js');
...
test('bench: TextEncoder/Decoder', async t => {
